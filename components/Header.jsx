...
const Header = () => {
    ...
    useEffect(() => {
        if (theme === 'light') {
            ...
            document.body.style.backgroundImage = "url('https://images.unsplash.com/photo-1637055159652-2b8837731f00?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80')"
        }
    })
